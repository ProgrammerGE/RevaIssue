...
export const routes: Routes = [
  ...
  { path: 'projects', component: Project, canActivate: [authorizationGuard] },
  { path: 'projects/:id', component: Project, canActivate: [authorizationGuard] },
  { path: 'issues', component: Issue, canActivate: [authorizationGuard] },
